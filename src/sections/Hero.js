    ...
    <div className="w-full py-10">
      <div className="relative flex flex-col px-10 mx-auto space-y-5 md:w-3/4">
        <header className="flex items-center justify-between space-x-3">
          ...
          <div
            className={[
              ...
              showMenu
                ? 'absolute z-50 flex flex-col py-5 space-x-0 shadow-xl md:py-0 left-8 right-8 bg-light top-24 space-y-3 md:space-y-0 px-5'
                : 'hidden',
            ].join(' ')}
          >
            <nav className="flex flex-col w-full space-x-0 space-y-3 text-center md:space-y-0 md:space-x-3 md:flex-row">
              <a className="px-5 py-2 hover:bg-gray-100">{t("common.label.guides")}</a>
              <a className="px-5 py-2 hover:bg-gray-100">{t("common.label.pricing")}</a>
              <a className="px-5 py-2 hover:bg-gray-100">{t("common.label.blog")}</a>
            </nav>
            <Link
              href={
                sessionStatus === 'authenticated' ? '/account' : '/auth/login'
              }
              className="w-full px-5 py-2 text-center text-light bg-blue-600 shadow hover:bg-blue-500"
            >
        ...
        <div className="flex items-center justify-center space-x-5">
          <a className="px-10 py-3 text-center text-light bg-blue-600 shadow hover:bg-blue-500">
            Get Started
          </a>
          <a className="px-10 py-3 text-center text-blue-600 shadow hover:bg-blue-50">
            Live Demo
          </a>
        </div>
      </div>
