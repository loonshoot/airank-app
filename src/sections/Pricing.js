  ...
  return (
    <div className="w-full py-10">
      <div className="relative flex flex-col px-5 mx-auto space-y-5 md:w-3/4">
        ...
        <div className="flex flex-col p-10 space-x-0 space-y-5 bg-gray-200-lg md:space-y-0 md:space-x-5 md:flex-row">
          <div className="flex flex-col items-start overflow-hidden bg-light border-lg md:w-1/2">
            <div className="w-full p-10 space-y-5">
              <span className="px-5 py-1 text-sm text-blue-600 uppercase bg-blue-100-full">
                Hobby
              </span>
              <h2 className="space-x-2 text-6xl">
                <span className="font-extrabold">Free</span>
                <small className="text-lg text-light">for life!</small>
              </h2>
            </div>
            <div className="flex flex-col w-full h-full p-10 space-y-5 bg-gray-100 border-t">
              <a
                className="px-10 py-3 text-lg text-center text-blue-600 bg-light shadow hover:bg-blue-50"
                href="#!"
              >
          ...
          <div className="flex flex-col items-start overflow-hidden bg-light border-lg md:w-1/2">
            <div className="w-full p-10 space-y-5">
              ...
              <h2 className="space-x-2 text-6xl">
                ...
                <small className="text-lg text-light">per month</small>
              </h2>
            </div>
            <div className="flex flex-col w-full h-full p-10 space-y-5 bg-gray-100 border-t">
              <a
